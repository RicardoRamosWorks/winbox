...
public:
	...
	virtual bool	ReadSectors			(PhysPt /*buffer*/, bool /*raw*/, unsigned long /*sector*/, unsigned long /*num*/) {
		return false;
	};
...
private:
	...
	public:
		...
		virtual Bit16u getEndian();
		virtual Bit16u decode(Bit8u *buffer);
		virtual Bit32u getRate();
		virtual Bit8u getChannels();
		int    getLength();
